...
namespace PetShop.Areas.Admin.Controllers
{
    public class TopicController : Controller
    {
        ...
        {
            // Để kiểm tra trạng thái, sắp xếp theo trên xuống
            // m là tham số ẩn danh
            var list = db.Topics.Where(m => m.Status != 0)
                .OrderBy(m => m.Id)
                .ToList();
            return View("Index", list);
        }
        // Mỗi lần tạo chức năng cho một trang mới thì nhớ add view vào
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Slug,ParentId,Orders,Metakey,Metadess,Created_By,Created_At,Updated_By,Updated_At,Status")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Slug,ParentId,Orders,Metakey,Metadess,Created_By,Created_At,Updated_By,Updated_At,Status")] Topic topic)
        {
            if (ModelState.IsValid)
            {
